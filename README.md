...
algorithms. We give the results and models of 9 OOD and 4 FGOOD methods on the DFGOVD. Based on this dataset, we expect more researchers to join the study of fine-grained oriented vehicle detection methods.
