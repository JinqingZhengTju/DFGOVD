...
## News 🎉
**January 2026:** We are thrilled to announce that our work has been **accepted by IEEE Transactions on Geoscience and Remote Sensing (TGRS)**!
**Paper Title:** DFGOVD: A New Dataset and Benchmark for Drone Fine-Grained Oriented Vehicle Detection in the Wild
...
## Data 
The DFGOVD dataset comprises 33,669 images, annotated with 816,239 vehicle instances using oriented bounding boxes covering 53 categories. For details on dataset annotation, splits, and usage instructions, please refer to [README_data.md](./code/README_data.md). 
### Data Access
